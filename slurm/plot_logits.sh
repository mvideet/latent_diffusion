#!/bin/bash
#SBATCH -J plot_logits
#SBATCH -o /data/sls/u/urop/mvideet/diffusion_reasoning/slurm/out/plot_logits%A_%a.out
#SBATCH -e /data/sls/u/urop/mvideet/diffusion_reasoning/slurm/err/plot_logits%A_%a.err
#SBATCH --qos=regular
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --requeue
