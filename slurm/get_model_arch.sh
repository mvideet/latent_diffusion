#!/bin/bash
#SBATCH -J get_model_arch
#SBATCH -o /data/sls/u/urop/mvideet/diffusion_reasoning/slurm/out/get_model_arch%A_%a.out
#SBATCH -e /data/sls/u/urop/mvideet/diffusion_reasoning/slurm/err/get_model_arch%A_%a.err
#SBATCH --qos=regular
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --requeue
